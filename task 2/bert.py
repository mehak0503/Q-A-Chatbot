...
class QA:
    ...
    def predict(self,passage :str,question :str):
        ...
        #print("Example ",example.qas_id,example.question_text,example.doc_tokens)
        features = squad_examples_to_features(example,self.tokenizer,self.max_seq_length,self.doc_stride,self.max_query_length)
        #print("Features ",len(features),features[0].unique_id,features[0].example_index,features[0].doc_span_index,len(features[0].tokens),features[0].tokens,features[0].token_to_orig_map,features[0].token_is_max_context)
        ...
        for batch in eval_dataloader:
            ...
            #print("66 in bert outputs ",outputs)
            for i, example_index in enumerate(example_indices):
                ...
                #print("Result ",len(result.start_logits),len(result.end_logits))
